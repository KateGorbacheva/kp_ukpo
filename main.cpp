...
bool isNumber(char a){
	if(sizeof(a)!=sizeof(double) || sizeof(a)!=sizeof(float) || sizeof(a)!=sizeof(int)){
		return false;
	}
	return true;
}
...
TEST(newTests, DoubleArgsTest){
    T_point a1,a2,b1,b2,c1,c2;
    a1.point_val_.real(6.1);
    a1.point_val_.imag(3.2);

    b1.point_val_.real(1.1);
    b1.point_val_.imag(3.3);

    c1.point_val_.real(3.2);
    c1.point_val_.imag(-1.1);

    a2.point_val_.real(3.0);
    a2.point_val_.imag(4.1);

    b2.point_val_.real(1.1);
    b2.point_val_.imag(1.1);

    c2.point_val_.real(6.1);
    c2.point_val_.imag(1.1);
    ...
    EXPECT_EQ(intersection_contour.vertices_.size(),6);
...
TEST(Triangle, Testthree){
        ...
        EXPECT_EQ(intersection_contour.vertices_.size(),3);
...
TEST(Triangle, Testfive){
    ...
    EXPECT_EQ(intersection_contour.vertices_.size(),5);
...
TEST(Triangle, Testfour){
    ...
    EXPECT_EQ(intersection_contour.vertices_.size(),4);
...
TEST(Triangle, Testtwo){
    ...
    EXPECT_EQ(intersection_contour.vertices_.size(),0);
...
TEST(Triangle, Testchecketriangle_onepoint){
    T_point a1,a2,b1,b2,c1,c2;
    a1.point_val_.real(6);
    a1.point_val_.imag(3);
    ...
    EXPECT_EQ(intersection_contour.vertices_.size(),1);

}
TEST(Triangle, Testchecketriangle_zeropoint){
    T_point a1,a2,b1,b2,c1,c2;
    a1.point_val_.real(6);
    a1.point_val_.imag(3);
